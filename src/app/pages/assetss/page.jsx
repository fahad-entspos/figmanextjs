...
<div className='flex flex-col w-[320px] mx-auto  sm:w-[30vw] p-3 items-center bg-white  rounded-xl'>
...
<div className='flex flex-col w-[320px] sm:w-[29vw] p-3 mx-auto bg-white  rounded-xl'>
...
<div className=' flex flex-col  sm:flex-nowrap w-[320px] sm:w-[60vw] h-auto sm:h-[220px] px-5 py-4  mx-auto     rounded-2xl mt-[1rem] bg-white'>
<div>
